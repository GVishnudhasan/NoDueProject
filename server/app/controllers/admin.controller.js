...
exports.getFacultybyDept = CatchAsyncError(async (req, res) => {
  try {
...
exports.getStudentbyDept = CatchAsyncError(async (req, res) => {
  try {
    const department = req.query.department;
...
exports.getCoursesbyDept = CatchAsyncError(async (req, res) => {
  try {
    const department = req.query.department;
